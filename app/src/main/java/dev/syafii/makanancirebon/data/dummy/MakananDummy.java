package dev.syafii.makanancirebon.data.dummy;
/*
...
public class MakananDummy {
    ...
    public static String[][] data = new String[][]{
            ...
            },
            {
                    "Gado - gado ayam",
                    "Rp.15.000",
                    "https://www.gotravelly.com/blog/wp-content/uploads/2018/04/gado-gado-ayam.jpg",
                    "Kuliner yang bernama gado-gado, terkenal dengan sebutan saladnya orang Indonesia. Di gado-gado, ada banyak sayuran yang dijadikan sebagai bahan. Nah, untuk kota Cirebon, ada satu hal yang membuat gado-gado unik.\n"+
                            "Di sini, gado-gado orang Cirebon ditambahkan dengan gulai kari ayam. Mungkin Anda bingung seperti apa rasa yang akan tercipta. Oleh karena itu, untuk membuktikan kelezatan Gado-gado Ayam khas Cirebon, Anda bisa langsung mencobanya sendiri.\n\n" +
                            "Karena gulai kari ayam memiliki rasa gurih yang khas, maka pastinya citarasa yang Anda rasakan lebih berwarna. Anda tak perlu repot-repot mencari kuliner khas yang satu ini. Tapi, untuk Gado-gado Ayam yang terbilang enak, Anda bisa pergi ke Jalan Kesambi. Sudah lebih dari satu dekade penjual Gado-gado Ayam menjajakan kuliner ini."
            },
            {
                    "Kerupuk Melarat",
                    "Rp.10.000",
                    "https://www.gotravelly.com/blog/wp-content/uploads/2018/04/kerupuk-melarat.jpg",
                    "Salah satu makanan khas dari Cirebon yang harus Anda coba dan bawa pulang sebagai oleh-oleh adalah Kerupuk Melarat. Benar sekali, kerupuk yang satu ini sangat enak dan renyah. Yang membuat makanan ringan ini enak adalah adanya saus kacang pedas yang disiram diatasnya." +
                            "Untuk Anda yang ingin membawa Kerupuk Melarat sebagai oleh-oleh, ada juga kerupuk yang dikemas dalam kemasan plastik. Perlu diketahui, jika Anda memakan kuliner khas Cirebon ini tidak akan membuat Anda melarat seperti namanya. Selain itu, harga yang ditawarkan juga sangat terjangkau. Warna-warni dari kerupuk ini akan menambah citarasa saat Anda hendak memakan makanan ringan ini."
            },
    };
    ...
    public static ArrayList<Makanan> getData() {
        ...
        for (String[] item : data) {
            ...
            makan.setName((item[0]));
            makan.setPrice(item[1]);
            makan.setImage(item[2]);
            makan.setDesciption(item[3]);
